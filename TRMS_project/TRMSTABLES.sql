...
ALTER TABLE TRMS_REIMBURST
    ADD GRADE_REC VARCHAR2(10);
...
I_GRADE IN TRMS_REIMBURST.GRADE_REC%TYPE)
AS
BEGIN
UPDATE TRMS_REIMBURST
SET GRADE_REC = I_GRADE
...
EXECUTE INSERT_REIMB_REQ (500875,25,'Intro to Humanities2','College class on Humanities2','Pawnee Community College','15-MAR-19',350,1,1);
EXECUTE INSERT_REIMB_REQ (300764,25,'appeal','appealing prison sentence','Prison','18-MAR-19',350,2,3);
