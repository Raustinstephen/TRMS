...
--I_EVENT_TYPE IN TRMS_REIMBURST.EVENT_ID%TYPE,
)
AS
BEGIN
...
EXECUTE INSERT_REIMB_REQ (103,'I want to',30.5, 'Basket Weaving', 'Basket Weaving under water', '42 Wallaby Way Queensland Australia', '2019/03/09 09:00:00 PM',78.84,4);
