CREATE TABLE TRMS_REIMBURST(
    ...
    EVENT_ID INTEGER,                        /*FK*/
    COST NUMBER(5,2),
    EST_REIMB NUMBER(5,2),
    WORKHOURS_MISSED NUMBER(5,2),    /*NOT NULL*/
...
I_GRADEFORM IN TRMS_EVENT.GRADING_FORMAT%TYPE,          --INTEGER
I_DATE  IN TRMS_EVENT.EVENT_DATE%TYPE,                  --STRING
I_EVENT_LOC IN TRMS_EVENT.EVENT_LOCATION%TYPE,          --STRING
I_COST IN TRMS_EVENT.EVENT_COST%TYPE,             --NUMBER
